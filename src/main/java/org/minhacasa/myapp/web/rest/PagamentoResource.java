...
public class PagamentoResource {
    ...
    public ResponseEntity<PagamentoDTO> createPagamento(@RequestBody PagamentoDTO pagamentoDTO) throws URISyntaxException {
    ...
    public ResponseEntity<PagamentoDTO> updatePagamento(@RequestBody PagamentoDTO pagamentoDTO) throws URISyntaxException {
